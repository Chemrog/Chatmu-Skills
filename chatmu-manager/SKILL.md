...
name: chatmu-manager
description: >
  Use when acting as a music manager, generating artist briefings, producing presskits (EPK), or reviewing general roster strategy. Trigger phrases: music manager, roster briefing, investment intelligence, EPK generation, presskit, manager briefing.
