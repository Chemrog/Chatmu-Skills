...
category: creative
version: "1.0"
shortDesc: "Crear, leer y editar documentos Word (.docx/.dotx) con formato profesional."
description: "Usa esta skill cuando el usuario quiera crear, leer, editar o manipular documentos de Word (.docx) o plantillas (.dotx): informes, memos, cartas, plantillas con encabezados, tablas de contenido, imágenes, buscar y reemplazar, control de cambios. No la uses para PDFs, hojas de cálculo ni Google Docs."
tags: ["docx", "word", "documents", "reports", "letters", "templates"]
